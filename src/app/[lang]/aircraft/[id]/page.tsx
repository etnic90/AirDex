...
export default async function AircraftPage({ params }: { params: Promise<{ lang: string, id: string }> }) {
  ...
  if (error || !data) {
    return (
      <div className="min-h-screen bg-slate-950 text-cyan-500 font-mono flex items-center justify-center">
        [ERROR 404] - AEREO NON TROVATO NEI REGISTRI
      </div>
    );
  }
  ...
  // Rarity Colors (Sci-Fi Hologram) allineati con la Card
  ...
  return (
    <main className="min-h-screen bg-slate-950 p-6 md:p-10 flex flex-col items-center">
      <div className="w-full max-w-5xl bg-slate-900/80 backdrop-blur-md rounded-2xl p-6 md:p-10 shadow-2xl border border-slate-800">
          ...
          {imageUrl ? (
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center bg-slate-900/80">
              ...
              <div className="z-10 flex flex-col items-center text-center">
                ...
                <span className="text-cyan-600/70 font-mono text-[9px] md:text-[10px] tracking-widest mt-2 uppercase animate-pulse">
                  Acquisizione Blueprint in corso...
                </span>
              </div>
            </div>
          )}
        ...
        {/* Descrizione Storica AI (Nuovo blocco) */}
