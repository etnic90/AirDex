  ...
  return (
    <main className="min-h-screen bg-slate-950 p-6 md:p-10 text-white relative overflow-hidden font-sans pb-24">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="bg-slate-900/60 border border-slate-900 rounded-3xl p-6 mb-8 backdrop-blur-md shadow-2xl flex flex-col gap-6">
          ...
          {/* Ordina per */}
          <div className="flex flex-wrap items-center justify-between gap-4 border-t border-slate-900/60 pt-4 text-xs font-mono">
            <div className="flex flex-wrap items-center gap-3">
              <span className="text-slate-500 uppercase text-[10px] font-bold">Ordina Risultati:</span>
              {[
                { id: "city", label: "📍 Città" },
                { id: "name", label: "🏨 Nome" },
