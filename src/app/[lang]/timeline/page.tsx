...
// Definiamo la struttura delle Ere storiche dell'aviazione
const ERAS = [
  {
    id: "pioneers",
  ...
  },
  {
    ...
    icon: "🚀",
    milestones: [
      { year: 1958, text: "Il Boeing 707 entra in servizio di linea per Pan Am, inaugurando ufficialmente l'era di massa del volo a reazione." },
      { year: 1969, text: "Volo inaugurale del Boeing 747 'Regina dei Cieli' e del velivolo supersonico Concorde anglo-francese." },
      { year: 1974, text: "Entra in servizio l'Airbus A300, il primo bireattore a fusoliera larga (widebody) al mondo." },
      { year: 1988, text: "L'Airbus A320 stabilisce un primato introducendo il sistema di controllo di volo digitale fly-by-wire." }
    ]
  },
  {
    id: "modern",
    title: "Efficienza & Compositi",
    years: "2000 - Oggi",
    description: "L'evoluzione si sposta sulla sostenibilità, sull'efficienza del carburante e sulla digitalizzazione. Nascono i velivoli intelligenti in carbonio composito, aerei giganti a due piani e motori turbofan ecologici.",
    ...
    icon: "📡",
    milestones: [
      { year: 2005, text: "Primo volo dell'Airbus A380 a Tolosa, il gigante a due piani passeggeri più capiente mai costruito." },
      { year: 2009, text: "Il Boeing 787 Dreamliner vola per la prima volta, introducendo l'uso estensivo di materiali in carbonio composito." },
      { year: 2013, text: "Inaugurazione dell'Airbus A350 XWB ad altissima efficienza e comfort per le rotte ultra-lunghe." },
      { year: 2026, text: "Integrazione dei combustibili SAF (Sustainable Aviation Fuel) su scala commerciale globale e sistemi avionici predittivi con AI." }
    ]
  }
];
  ...
  if (loading) {
    return (
      <main className="min-h-screen bg-slate-950 flex flex-col items-center justify-center text-cyan-500 font-mono">
        ...
        <p className="text-sm tracking-[0.3em] animate-pulse">ALLINEAMENTO LINEA TEMPORALE...</p>
      </main>
    );
  }
    ...
    <main className="min-h-screen bg-slate-950 text-slate-100 p-6 md:p-10 relative overflow-hidden font-mono pb-24">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-cyan-500/10 border border-cyan-500/20 text-cyan-400 text-[10px] tracking-widest uppercase mb-4 shadow-[0_0_15px_rgba(6,182,212,0.1)]">
          ...
          {ERAS.map((era) => {
            ...
            return (
              <button
                ...
                className={`p-5 rounded-2xl border text-left transition-all duration-300 relative overflow-hidden group select-none flex flex-col justify-between ${
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-8 space-y-8 relative pl-6 md:pl-10">
            ...
            {filteredAircrafts.length > 0 ? (
              filteredAircrafts.map((aircraft, idx) => {
                      ...
                      <div className="w-full md:w-44 h-32 md:h-auto rounded-2xl bg-slate-950 border border-slate-900/60 overflow-hidden relative shrink-0 flex items-center justify-center p-2">
                        {aircraft.house_livery_url ? (
                          <img 
                            ...
                            className="max-w-full max-h-full object-contain filter drop-shadow-[0_4px_8px_rgba(0,0,0,0.5)] group-hover:scale-105 transition-transform duration-500"
                          />
                        ) : (
                      ...
                      <div className="flex-grow flex flex-col justify-between font-mono text-xs gap-4">
                        ...
                        <div className="flex justify-between items-center pt-2.5 border-t border-slate-900/60 mt-auto">
                          ...
                          <Link 
                            ...
                            className="text-[10px] text-cyan-400 hover:text-cyan-300 font-bold uppercase tracking-widest hover:underline flex items-center gap-1.5"
                          >
                            <span>Dettagli</span>
                            <span>&rarr;</span>
                          </Link>
